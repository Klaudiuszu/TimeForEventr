...
export default function DJSection({ messages }: DJSectionProps) {
    return (
      <section id='about' className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between p-6 md:p-12 gap-8 overflow-hidden bg-gradient-to-b from-dj-dark to-[#2a2725]">
        <div className="flex-1 flex justify-center">
          <Image 
            src="/dominik.png" priority 
            alt="DJ Silhouette"
            width={400} 
            height={400}
